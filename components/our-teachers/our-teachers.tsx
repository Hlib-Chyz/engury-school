      ...
      <div className={styles.teacher}>
        ...
        <section className={styles.about}>
          ...
          <div className={styles.text}>
            ...
            />
            <p>
              Я викладач з 10-ти річним досвідом роботи . Стосовно особистісного
              досвіду – я навчалась в університеті викладацької діяльності у
              Великій Британії, де ідеально вдосконалила свою розмовну та
              професійну англійську. Вже навчила більше 15000 студентів.
            </p>
            <Image
